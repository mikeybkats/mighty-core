...
const KitSoundEntry kTwelveSounds[] = {
    ...
    {"s04", "4"}, {"s05", "5"}, {"s06", "6"}, {"s07", "7"},
    {"s08", "8"}, {"s09", "9"}, {"s10", "10"}, {"s11", "11"},
    {nullptr, nullptr},
};

// Thirteen would-be entries: helpers must never report more than kKitMaxSounds.
const KitSoundEntry kThirteenSounds[] = {
    {"t00", nullptr}, {"t01", nullptr}, {"t02", nullptr}, {"t03", nullptr},
    {"t04", nullptr}, {"t05", nullptr}, {"t06", nullptr}, {"t07", nullptr},
    {"t08", nullptr}, {"t09", nullptr}, {"t10", nullptr}, {"t11", nullptr},
    {"t12", "extra"}, // unreachable for count, but present in storage
    {nullptr, nullptr},
};
