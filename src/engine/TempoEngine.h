...
#endif
{
 ...
 private:
  ...
  void renderClickSample(float* buf, int32_t frameOffset, int32_t clickSample, int32_t count,
  ...
  // In two-beat mode, backbeats (odd beat index) are quieter so 1–2 grouping is obvious even with
  // swing at 0.
